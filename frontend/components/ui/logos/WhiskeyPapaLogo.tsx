...
type WhiskeyPapaLogoProps = {
  className?: string;
};

export function WhiskeyPapaLogo({ className }: WhiskeyPapaLogoProps) {
  return (
  <svg
    ...
    className={cn('icon icon-tabler icons-tabler-outline icon-tabler-leaf-2', className)}>
